...
public class MainScreen extends FullFunctionScreen{
	...
	public void initAllObjects(List<Visible> viewObjects) {
		viewObjects.add(new Graphic(40, 300, 130, 50,"resources/clickme.jpeg"));
		TextLabel countdown = new TextLabel(100, 100, 300, 150, "");
		TextLabel timer = new TextLabel(100, 300, 300, 150, "");
		...
		button = new Button(40, 300, 130, 50, "Ready", new Action() {
			@Override
			public void act() {
				if (ready) {
